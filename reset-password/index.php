...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-4 rounded text-center mt-5 border p-3">
                ...
                <?php } else { ?>
                    ...
                    <form class="form-auth" action="includes/sendtoken.inc.php" method="post">
                        ...
                        <div class="text-center ">
                            ...
                            Enter the email address associated with your Azhaga account. 
                        ...
                        <button class="btn btn-sm btn-primary text-center  mb-5 mt-4" type="submit" value="resentsend" name="resentsend">
                            continue
                        </button>
